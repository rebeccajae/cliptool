...
@Suite("base64") struct Base64Tests {
...
@Suite("callWithString") struct CallTests {
...
@Suite("defrule") struct DefruleTests {
...
@Suite("integration") struct IntegrationTests {
